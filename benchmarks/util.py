# yoinked from millipds, maybe some of this should be in atmst?
...
def enumerate_blobs(obj: cbrrr.DagCborTypes) -> Iterable[cbrrr.CID]:
	if type(obj) is dict:
		if obj.get("$type") == "blob":
			yield obj["ref"]
		else:
			for subobj in obj.values():
				yield from enumerate_blobs(subobj)
